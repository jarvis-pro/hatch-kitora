...
- **PR-3**（schema + 支付）—— `prisma/migrations/20260601000000_add_cn_subscription_fields/`、`prisma/migrations/20260601001000_add_billing_event_table/`、`src/lib/billing/provider/{alipay,wechat,cn-price-config}.ts`、`src/app/api/billing/{alipay,wechat}/notify/route.ts`、env 9 项 + 2 个 SDK 依赖。
